...
Every plan below is planned, not implemented. Current order: **043 → 033 → 042 → 040 → 034 → 037 → 035**.

Ordering rule: zero-risk cleanup, the prioritized history work and the data-loss guards came first and are complete; now the maintainer-requested shortcut fix 043, audit fixes in their original order, then optional or measured work, and 035 last. Keep 035 last even when later-numbered implementation or fix plans are added: schedule those before it.

| Plan | Source | Scope |
| --- | --- | --- |
| [043 — Physical shortcut keys](043-physical-shortcut-keys.md) | 2026-09-26 plan 032 finding; maintainer request; Cap comparison | Register global shortcuts by physical key so the default ⌘⇧1 works under Zhuyin and other layouts whose number row types no digits; letter shortcuts on non-QWERTY Latin layouts follow the US position, an accepted trade-off |
...
- 043 and 033 can run independently; 043 goes first as a user-visible shortcut failure.
...
- Cap comparisons in each plan are pinned to revision `ce785e705e79652adba4b8bf752669c4093499e0`; 037 and the closed 038 pin `26e1a6d882f311d10b5317e9e0d29babe4f6737e`; 040 pins `119edf04864b59abfc0d52f60bf77d7f33cfd2b8`; 043 pins `40f44a803f0980fb7ed530f17d12b8fed40f6b5a`; the closed 041 pins `b2b6ae45d4cae303107b10a9df166d91caed7702` and reads Chromium at tag 152.0.7977.78. They are static comparisons of the inspected scope, not evidence that Cap handles these cases.
