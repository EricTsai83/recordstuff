...
以下計畫皆已規劃、尚未實作。目前順序：**030 → 031 → 032 → 033 → 040 → 034 → 037 → 035**。
...
- 037 依賴 025、026、029、030、036 與 038（除 030 外皆已完成），須維持 036 在全部媒體工作之後才處理 metadata 的退出階段，並重用 038 定義的寫入積壓上限。
