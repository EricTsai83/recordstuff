...
狀態：尚未開始；設計已提出，程式尚未動工。優先順序：021 → 022。建立：2026-09-21。更新：2026-09-23，整合 focus 與自訂快捷鍵 UI 精修。
...
020 已完成自訂快捷鍵功能；已完成的 [023](../docs/zh-TW/system-design/desktop.md#設定快捷鍵) 負責開啟設定的全域快捷鍵及捕捉期間的註冊管理，[021](021-screen-selection.zh-TW.md) 新增螢幕選擇。執行順序為 021 → 022，本計畫統一完成整體版面、focus 與快捷鍵編輯 UI，避免分成兩輪樣式重作。快捷鍵捕捉沿用上述功能的清理與註冊生命週期。
