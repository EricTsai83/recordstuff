...
- All plans and their translations live together in root plans/: English uses <name>.md, Traditional Chinese uses <name>.zh-TW.md, including README.md / README.zh-TW.md. Do not place plan translations under docs/zh-TW/. Follow the order and status in plans/README.md when asked to execute the next plan. Plans contain unfinished work only; completed/canceled plans are removed after durable information is captured in docs.
