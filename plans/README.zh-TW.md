...
更新：2026-09-19。v0.1.1 已公開；見[本版證據](../docs/zh-TW/verification/releases/0.1.1.md)。013 的原始碼變更已實作並在本機驗證；0.1.2 發布、安裝驗收與移除檢查尚待完成，記錄於 [0.1.2 證據](../docs/zh-TW/verification/releases/0.1.2.md)。操作見 [發布自動化](../docs/zh-TW/system-design/releases.md)。

## 順序與狀態

| 順序 | 計畫 | 狀態 | 交付目標 |
| --- | --- | --- | --- |
| 接續 | [013 安裝體驗](013-macos-installation-experience.zh-TW.md) | 原始碼已實作；待發布 | 以 CI 發布 0.1.2、人工驗收安裝／取代／錄影、在可丟棄副本驗證移除 |
