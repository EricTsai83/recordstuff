...
以下計畫皆已規劃、尚未實作。目前順序：**037 → 035**。

排序規則：零風險整理、優先的歷史保存工作與防止資料損失的防護已排在最前並完成，維護者要求的快捷鍵後續 044、最後一項 audit 修正 033、更快的錄影回合 042、錄影前倒數 040 與 Windows 系統匣圖示 034 也已完成（034 的原生 Windows 驗收移至 035）；目前處理需量測的工作，035 永遠最後。即使之後新增更大編號的實作／修復計畫，也排在 035 之前。
