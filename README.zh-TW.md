...
下載 **[RecordStuff 0.1.4：macOS Apple silicon（arm64）](https://github.com/EricTsai83/recordstuff/releases/download/v0.1.4/RecordStuff-0.1.4-arm64-selfsigned.dmg)**（127,322,041 bytes）。[英文發行說明](https://github.com/EricTsai83/recordstuff/releases/tag/v0.1.4) · [SHA256SUMS](https://github.com/EricTsai83/recordstuff/releases/download/v0.1.4/SHA256SUMS) · [最新版本](https://github.com/EricTsai83/recordstuff/releases/latest)。
