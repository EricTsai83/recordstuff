...
| --- | --- | --- | --- |
| Next | [018 In-app update check](018-app-update.md) | Local manual acceptance and automated integration/real capture passed; Public feed deployed and verified; installed-App check against live feed pending | A tray check against the published version feed that points at the download; installation stays manual |
