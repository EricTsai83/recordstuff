...
Playback confirmation by the maintainer (optional), then the `v0.1.2` tag push and its CI run (link, size, SHA-256), with an optional browser download checksum. No result is claimed for any of these.
