...
Every plan below is planned, not implemented. Current order: **037 → 035**.

Ordering rule: zero-risk cleanup, the prioritized history work and the data-loss guards came first and are complete, as are the maintainer-requested shortcut follow-up 044, the last audit fix, 033, the faster recording rounds, 042, the recording countdown, 040, and the Windows tray artwork, 034, whose native Windows acceptance moved to 035; now measured work, and 035 last. Keep 035 last even when later-numbered implementation or fix plans are added: schedule those before it.
...
- 037 depends on 025, 026, 029, 030, 036, 038, 040 and 041 (all complete), keeps 036's metadata quit phase after all media work, reuses the writer backlog bound defined in 038, treats 040's counting-down session as active and compares its timing against 041's cadence baseline.
...
- Cap comparisons in each plan are pinned to revision `ce785e705e79652adba4b8bf752669c4093499e0`; 037 and the closed 038 pin `26e1a6d882f311d10b5317e9e0d29babe4f6737e`; the closed 040 pins `119edf04864b59abfc0d52f60bf77d7f33cfd2b8`; the closed 043 pins `40f44a803f0980fb7ed530f17d12b8fed40f6b5a`; the closed 041 pins `b2b6ae45d4cae303107b10a9df166d91caed7702` and reads Chromium at tag 152.0.7977.78. They are static comparisons of the inspected scope, not evidence that Cap handles these cases.
