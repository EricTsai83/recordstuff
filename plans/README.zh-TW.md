...
以下計畫皆已規劃、尚未實作。目前順序：**032 → 033 → 042 → 040 → 034 → 037 → 035**。
...
- 032 與 033 可獨立執行；若其他工作需要更新驗收，先處理 032。
