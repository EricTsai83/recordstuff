...
| 順序 | 計畫 | 狀態 | 交付目標 |
| --- | --- | --- | --- |
| 下一個 | [012 官方網站](012-download-website.zh-TW.md) | 可直接執行（`website/` 內仿 T3 Code 風格的純英文 Astro 站、建置時驗證的 manifest、Vercel 由維護者自行設定；部署前先比較三個版本） | 產品／說明網站、DMG 直接下載與版本／checksum 資訊 |
| 網站上線後 | [018 App 內更新檢查](018-app-update.zh-TW.md) | 可執行；取代延後的 015 評估，維護者已於 2026-09-20 決定實作 | Tray 對已發布版本 feed 做檢查並連到下載頁，安裝仍為手動 |
