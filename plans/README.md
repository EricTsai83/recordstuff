...
Next: [023 — Open Settings with a global shortcut](023-settings-shortcut.md) (not started). Let computer use open and focus the real Settings panel without a maintainer click, including registration conflicts and native keyboard acceptance. Execution order: 023 → 021 → 022; existing plan numbers are unchanged.
