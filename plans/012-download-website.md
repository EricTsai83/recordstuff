...
3. Document release maintenance: after publishing and checking a new artifact, update the site's metadata and matching checksum/notes, validate links and deploy. Coordinate this step with 011 if later implemented. Exclude drafts/prereleases unless explicitly offering them. On metadata failure, retain a clearly labeled last verified version or link to Releases without asserting latest; do not render a broken download button.
